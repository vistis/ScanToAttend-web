...
/**
 * Student Dashboard — shows enrolled classes and today's schedule.
 */
definePageMeta({
  layout: 'dashboard',
  middleware: ['student'],
...
/** Filter classes that have sessions today, with only today's sessions */
  ...
  <div>
    <div class="mb-6">
      ...
      <p class="text-slate-500 dark:text-slate-400 mt-1">
        Your enrolled courses and today's schedule.
      </p>
    </div>
