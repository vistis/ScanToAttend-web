      ...
      _push(ssrRenderComponent(_component_LoadingState, { loading: unref(loading) }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="mt-8"${_scopeId}><h2 class="text-lg font-semibold text-slate-800 dark:text-slate-200 mb-4"${_scopeId}> Enrolled Courses </h2><div class="card overflow-hidden p-0"${_scopeId}>`);
            ...
            return [
              ...
              createVNode("div", { class: "mt-8" }, [
                createVNode("h2", { class: "text-lg font-semibold text-slate-800 dark:text-slate-200 mb-4" }, " Enrolled Courses "),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/student/schedule.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=schedule-ELK2c6AQ.mjs.map
