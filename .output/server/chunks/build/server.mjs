import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { defineComponent, computed, h, ref, readonly, hasInjectionContext, inject, toRef, isRef, Suspense, onServerPrefetch, getCurrentInstance, Fragment, toValue, shallowRef, watch, provide, shallowReactive, nextTick, unref, defineAsyncComponent, createElementBlock, cloneVNode, useSSRContext, createApp, withCtx, createVNode, onErrorCaptured, resolveDynamicComponent, reactive, effectScope, mergeProps, getCurrentScope, isReadonly, isShallow, isReactive, toRaw } from 'vue';
import { k as klona, e as createError$1, l as parseURL, m as encodePath, n as decodePath, o as hasProtocol, q as isScriptProtocol, j as joinURL, w as withQuery, r as getRequestURL, s as parse, t as getRequestHeader, f as destr, v as isEqual, x as sanitizeStatusCode, y as defuFn, z as setCookie, A as getCookie, B as deleteCookie, C as getContext, $ as $fetch$1, D as baseURL, E as createHooks, F as defu, G as executeAsync, H as getResponseHeaders, I as getRequestHeaders, J as splitCookiesString, K as setResponseHeaders, L as FetchError } from '../nitro/nitro.mjs';
import { RouterView, useRoute as useRoute$1, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { createConsola } from 'consola';
import { ssrRenderTeleport, ssrRenderList, ssrRenderClass, ssrRenderComponent, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from 'vue/server-renderer';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-W9E2GILs.mjs')
  },
  {
    name: "login",
    path: "/login",
    meta: { ...__nuxt_page_meta$c || {}, ...{ "middleware": ["guest"] } },
    component: () => import('./login-B_CYb1MQ.mjs')
  },
  {
    name: "admin",
    path: "/admin",
    meta: { ...__nuxt_page_meta$b || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./index-DnuBmfdB.mjs')
  },
  {
    name: "admin-classes",
    path: "/admin/classes",
    meta: { ...__nuxt_page_meta$a || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./classes-DSAou-N3.mjs')
  },
  {
    name: "admin-courses",
    path: "/admin/courses",
    meta: { ...__nuxt_page_meta$9 || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./courses-CR2G-xWx.mjs')
  },
  {
    name: "student",
    path: "/student",
    meta: { ...__nuxt_page_meta$8 || {}, ...{ "middleware": ["student"] } },
    component: () => import('./index-BQ76SODZ.mjs')
  },
  {
    name: "admin-students",
    path: "/admin/students",
    meta: { ...__nuxt_page_meta$7 || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./students-B090Pc-V.mjs')
  },
  {
    name: "admin-enrollment",
    path: "/admin/enrollment",
    meta: { ...__nuxt_page_meta$6 || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./enrollment-C2c0JQSP.mjs')
  },
  {
    name: "instructor",
    path: "/instructor",
    meta: { ...__nuxt_page_meta$5 || {}, ...{ "middleware": ["instructor"] } },
    component: () => import('./index-DM_XiUM-.mjs')
  },
  {
    name: "student-schedule",
    path: "/student/schedule",
    meta: { ...__nuxt_page_meta$4 || {}, ...{ "middleware": ["student"] } },
    component: () => import('./schedule-ELK2c6AQ.mjs')
  },
  {
    name: "admin-instructors",
    path: "/admin/instructors",
    meta: { ...__nuxt_page_meta$3 || {}, ...{ "middleware": ["admin"] } },
    component: () => import('./instructors-CjSq49PG.mjs')
  },
  {
    name: "student-class-id",
    path: "/student/class/:id()",
    meta: { ...__nuxt_page_meta$2 || {}, ...{ "middleware": ["student"] } },
    component: () => import('./_id_-C6OFF59B.mjs')
  },
  {
    name: "instructor-schedule",
    path: "/instructor/schedule",
    meta: { ...__nuxt_page_meta$1 || {}, ...{ "middleware": ["instructor"] } },
    component: () => import('./schedule-CNpeQpqV.mjs')
  },
  {
    name: "instructor-class-id",
    path: "/instructor/class/:id()",
    meta: { ...__nuxt_page_meta || {}, ...{ "middleware": ["instructor"] } },
    component: () => import('./_id_-BAuK6AvP.mjs')
  }
];
...
const namedMiddleware = {
  admin: () => import('./admin-NeQOE6e9.mjs'),
  auth: () => import('./auth-DqJ7qwAF.mjs'),
  guest: () => import('./guest-D1np_6lN.mjs'),
  instructor: () => import('./instructor-DXi8PgG9.mjs'),
  student: () => import('./student-DAYhJptd.mjs'),
  "sanctum:auth": () => import('./sanctum.auth-BDsR5_sA.mjs'),
  "sanctum:guest": () => import('./sanctum.guest-BGW7ei27.mjs')
};
...
const plugin_VGlXaiAZ9oX5MlbMW2MyhhHQbvhhlhgUHnlHBvRiX2I = /* @__PURE__ */ defineNuxtPlugin({
  name: "@nuxt/icon",
  setup() {
...
async function setupDefaultTokenStorage(nuxtApp, logger) {
  ...
  const defaultStorage = await import('./cookieTokenStorage-CtLU6TQ8.mjs');
...
const plugin_Oi0PdZ7ZSxWGSgZRoz8AGBY9Vg_aHPh_q_9gqhK_lpg = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  ...
  plugin_VGlXaiAZ9oX5MlbMW2MyhhHQbvhhlhgUHnlHBvRiX2I,
  plugin_Oi0PdZ7ZSxWGSgZRoz8AGBY9Vg_aHPh_q_9gqhK_lpg
];
const layouts = {
  auth: defineAsyncComponent(() => import('./auth-B4m84kM7.mjs').then((m) => m.default || m)),
  dashboard: defineAsyncComponent(() => import('./dashboard-BsRrzp_r.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-CPWqtnNV.mjs').then((m) => m.default || m))
};
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        _push2(`<div class="fixed top-4 right-4 z-[100] flex flex-col gap-2 pointer-events-none"><!--[-->`);
        ssrRenderList(unref(toasts2), (toast) => {
          _push2(`<div class="${ssrRenderClass([colorMap[toast.type], "pointer-events-auto flex items-center gap-2.5 px-4 py-3 rounded-xl border shadow-lg backdrop-blur-sm max-w-sm"])}">`);
          _push2(ssrRenderComponent(_component_Icon, {
            name: iconMap[toast.type],
            class: ["w-5 h-5 flex-shrink-0", iconColorMap[toast.type]]
          }, null, _parent));
          _push2(`<p class="text-sm font-medium flex-1">${ssrInterpolate(toast.message)}</p><button class="flex-shrink-0 opacity-60 hover:opacity-100 transition-opacity">`);
          _push2(ssrRenderComponent(_component_Icon, {
...
const __nuxt_component_2 = Object.assign(_sfc_main$3, { __name: "ToastContainer" });
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Uw0WbsGJ.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DufLL51x.mjs'));
...
export { IDENTITY_LOADED_KEY as I, __nuxt_component_0 as _, useCookie as a, useHead as b, useToast as c, useRoute as d, entry_default as default, useRuntimeConfig as e, defineNuxtRouteMiddleware as f, useSanctumConfig as g, createError as h, useDarkMode as i, useRouter as j, encodeRoutePath as k, useNuxtApp as l, nuxtLinkDefaults as m, navigateTo as n, useSanctumUser as o, useSanctumAppConfig as p, useState as q, resolveRouteObject as r, __nuxt_component_0$1 as s, useRequestURL as u };
